...
-- Module  Version: 5.7
--/usr/local/diamond/3.10_x64/ispfpga/bin/lin64/scuba -w -n pll_train -lang vhdl -synth lse -arch xo2c00 -type pll -fin 50 -fclkop 50 -fclkop_tol 0.0 -fclkos 50 -fclkos_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 0 -trims_r -phase_cntl STATIC -fb_mode 1 

-- Wed Aug 14 00:17:28 2019
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  9, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  9, 
        ...
        CLKOS_DIV=>  10, CLKOP_DIV=>  10, CLKFB_DIV=>  1, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of pll_train is
    for Structure
